...
Java_com_wzw_jnilibrary_JniArrayOperation_getIntArray(JNIEnv *env, jobject thiz, jint length) {
    //创建一个指定大小的数组
...
Java_com_wzw_jnilibrary_JniArrayOperation_sortIntArray(JNIEnv *env, jobject thiz, jintArray arr_) {
    //获取数组起始元素的指针
